...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axi_regmap_0_REG0_OUT [get_bd_pins axi_regmap_0/REG0_OUT] [get_bd_pins multiplier_0/A]
  connect_bd_net -net axi_regmap_0_REG1_OUT [get_bd_pins axi_regmap_0/REG1_OUT] [get_bd_pins multiplier_0/B]
  connect_bd_net -net axi_regmap_0_REG2_OUT [get_bd_pins axi_regmap_0/REG2_OUT] [get_bd_pins multiplier_0/rst]
  connect_bd_net -net multiplier_0_R [get_bd_pins multiplier_0/R] [get_bd_pins slicer_0/R]
  connect_bd_net -net multiplier_0_done [get_bd_pins axi_regmap_0/REG2_IN] [get_bd_pins multiplier_0/done]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins multiplier_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net slicer_0_R_high [get_bd_pins axi_regmap_0/REG0_IN] [get_bd_pins slicer_0/R_high]
  connect_bd_net -net slicer_0_R_low [get_bd_pins axi_regmap_0/REG1_IN] [get_bd_pins slicer_0/R_low]
