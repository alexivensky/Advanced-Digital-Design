...
HD_PWD='C:/Users/alexivensky/ADDLabs/lab_3/lab_3.runs/design_1_slicer_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_slicer_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_slicer_0_0.tcl
