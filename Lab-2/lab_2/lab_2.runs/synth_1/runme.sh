...
HD_PWD='C:/Users/alexivensky/ADDLabs/Lab-2/lab_2/lab_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab_2_wrapper.tcl
