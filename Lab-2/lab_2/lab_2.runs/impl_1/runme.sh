...
HD_PWD='C:/Users/alexivensky/ADDLabs/Lab-2/lab_2/lab_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab_2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab_2_wrapper.tcl -notrace
