...
################################################################
# This is a generated script based on design: lab_2
#
...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net alu_0_Overflow [get_bd_pins alu_0/Overflow] [get_bd_pins axi_regmap_0/REG5_IN]
  connect_bd_net -net alu_0_R [get_bd_pins alu_0/R] [get_bd_pins axi_regmap_0/REG0_IN]
  connect_bd_net -net alu_0_Zero [get_bd_pins alu_0/Zero] [get_bd_pins axi_regmap_0/REG4_IN]
  connect_bd_net -net axi_regmap_0_REG0_OUT [get_bd_pins alu_0/A] [get_bd_pins axi_regmap_0/REG0_OUT]
  connect_bd_net -net axi_regmap_0_REG1_OUT [get_bd_pins alu_0/B] [get_bd_pins axi_regmap_0/REG1_OUT]
  connect_bd_net -net axi_regmap_0_REG2_OUT [get_bd_pins alu_0/SHAMT] [get_bd_pins axi_regmap_0/REG2_OUT]
  connect_bd_net -net axi_regmap_0_REG3_OUT [get_bd_pins alu_0/ALUOp] [get_bd_pins axi_regmap_0/REG3_OUT]
