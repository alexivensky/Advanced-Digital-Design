...
HD_PWD='C:/Users/alexivensky/ADDLabs/Lab-1/Lab_1/Lab_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_1_wrapper.tcl
