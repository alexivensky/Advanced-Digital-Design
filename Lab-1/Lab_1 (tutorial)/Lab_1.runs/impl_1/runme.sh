...
HD_PWD='C:/Users/alexivensky/ADDLabs/Lab-1/Lab_1/Lab_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_1_wrapper.tcl -notrace
