...
HD_PWD='C:/Users/alexivensky/ADDLabs/lab_4/lab_4.runs/design_1_CPU_no_mem_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_CPU_no_mem_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_CPU_no_mem_0_0.tcl
