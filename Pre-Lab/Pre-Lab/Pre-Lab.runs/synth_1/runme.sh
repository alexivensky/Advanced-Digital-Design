...
HD_PWD='C:/Users/alexivensky/ADDLabs/Pre-Lab/Pre-Lab/Pre-Lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pre_lab.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pre_lab.tcl
