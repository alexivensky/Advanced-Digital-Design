...
HD_PWD='C:/Users/alexivensky/ADDLabs/Pre-Lab/Pre-Lab/Pre-Lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pre_lab.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pre_lab.tcl -notrace
